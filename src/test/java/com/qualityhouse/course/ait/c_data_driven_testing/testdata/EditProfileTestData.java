...
public class EditProfileTestData {
    ...
    // todo: Exercise C-2.2a - populate test data with correct user profile details
    ...
    // todo: Exercise C-2.3a - populate test data with incorrect user profile details, to provoke the system to handle errors
